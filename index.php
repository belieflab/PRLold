...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="code/card_task_01.css">
...
<body>
  ...
  <h3 id="consentPreamble" class="consent">This is a web version of the Probabilistic Reversal Learning (PRL) task. Click to proceed. <br /> <br /> </h3>
...
<script type="text/javascript" src="code/card_task_01.js"></script>
<script>
