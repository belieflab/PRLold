...
email 						= data.getvalue("email", "EMAIL_NULL")
...
interruptionAns				= data.getvalue("interruptionAns", "EXCLUDEDREASON_NULL")
comments 					= data.getvalue("comments", "EXCLUDEDREASON_NULL")
estimatedPerformanceAns		= data.getvalue("estimatedPerformanceAns", "EXCLUDEDREASON_NULL")
surveyThoughts				= data.getvalue("surveyThoughts", "EXCLUDEDREASON_NULL")
...
with open(fileName, 'a') as csvFile:
	...
	for row in range(numRows):
		csvWriter.writerow([email, startDate, endDate, userAgentString, trialNums[row],
			...
			interruptionAns, comments, surveyThoughts, estimatedPerformanceAns])
